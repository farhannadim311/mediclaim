...
export const claimWitnesses = {
    VERIFY_CLAIM_SIGNATURE({ privateState }, claimHash, providerPubX, providerPubY, signatureR8x, signatureR8y, signatureS) {
        ensureInitialized();
        try {
            const A = [
            ...
            const R8 = [F.e(u8To0xHex(signatureR8x)), F.e(u8To0xHex(signatureR8y))];
    ...
    VERIFY_CLAIM_AMOUNT({ privateState }, claimType, amount) {
    ...
    VERIFY_SERVICE_DATE({ privateState }, serviceDate, currentTimestamp) {
    ...
    VERIFY_PROVIDER_AUTHORIZATION({ privateState }, providerId, claimType) {
    ...
    VERIFY_PATIENT_ELIGIBILITY({ privateState }, patientId, claimType) {
...
export function createSampleClaimPrivateState() {
...
//# sourceMappingURL=claim-witnesses.js.map